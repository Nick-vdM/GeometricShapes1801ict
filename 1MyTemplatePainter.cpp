...
public:
    ...
    Point(int pXAnchor, int pYAnchor, char pSymbol) : xAnchor{pXAnchor},
...
public:
    ...
    Line(int pXAnchor, int pYAnchor, int pToX, int pToY, char pSymbol) : xAnchor{pXAnchor}, yAnchor{pYAnchor},
...
public:
    ...
    void paint() {
        ...
        if (strcmp(itemType, "point") == 0) {
            paintShape(points, index);
        } else if (strcmp(itemType, "line") == 0) {
            paintShape(lines, index);
        } else if (strcmp(itemType, "ellipse") == 0) {
            paintShape(ellipses, index);
        } else if (strcmp(itemType, "polygon") == 0) {
            paintShape(polygons, index);
        }
    }
...
private:
    ...
    void paintAll() {
        ...
        for (int i = 0; i < ellipses.getTop(); i++) {
            ellipses[i].draw(board);
        }
        for (int i = 0; i < polygons.getTop(); i++) {
            polygons[i].draw(board);
        }
        board.display();
    }
